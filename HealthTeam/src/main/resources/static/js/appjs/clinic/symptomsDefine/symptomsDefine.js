...
function reLoad() {
	var opt = {
		query: {
			...
			symptomsIndex:$('#symptomsIndex').val(),
		}
	}
...
function remove(id,symptoms) {
	layer.confirm('确定要删除'+symptoms+'？', {
		btn : [ '确定', '取消' ]
	}, function() {
		$.ajax({
			url : prefix + "/remove",
