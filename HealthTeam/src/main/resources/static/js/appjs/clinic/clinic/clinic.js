								...
								},
								{
									...
									formatter : function(value, row, index) {
										...
										var d = '<a class="btn btn-primary btn-sm '
												+ s_set_h
												+ '" href="#" title="管理员设置"  mce_href="#" onclick="set(\''
												+ value.clinicId
												+ '\',\''
												+ value.clinicName
												+ '\')">管理员设置</a> ';
										var e = '';
										if (value.clinicParentId == null
												|| value.clinicParentId == '') {
											e = '<a class="btn btn-primary btn-sm '
													+ s_add_h
													+ '" href="#" title="增加分公司"  mce_href="#" onclick="adds(\''
													+ value.clinicId
													+ '\',\''
													+ value.clinicName
													+ '\')">增加分公司</a> ';
